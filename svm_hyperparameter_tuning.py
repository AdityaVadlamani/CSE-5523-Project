...
kernels = ['rbf', 'linear', ('poly', 2), ('poly', 3), 'sigmoid']
max_accuracy = 0
best_fp = 0
best_fn = 0
best_kernel = ''
...
for kernel in kernels:
    ...
    print('Testing with '+ str(kernel) + ' kernel')
    ...
    for trial in range(10):
        ...
        if isinstance(kernel, str):
            ...
            model = svm.SVC(kernel = kernel[0], degree = kernel[1])
...
print("\nBest Kernel: {}".format(str(best_kernel)))
